...
const Terms = () => {
  return (
    <div className='termsContainer'>
      <h3>Robin - Terms and Conditions</h3>
      <div>
        <div>
          <h5>Effective as of March 26, 2020</h5>
          <h5>Updated August 19, 2020</h5>
          <br></br>
          <br></br>
          <b>Agreement between user and myrobin.io</b>
          <p>
            Welcome to Robin. The myrobin.io website (the "Site") consists of
            various web pages operated by IntroLab, Inc ("IntroLab"). myrobin.io
            is offered to you conditioned on your acceptance without
            modification of the terms, conditions, and notices contained herein
            (the "Terms"). Your use of myrobin.io constitutes your agreement to
            all such Terms. Please read these terms carefully, and keep a copy
            of them for your reference. myrobin.io helps junior software
            engineers prepare for coding interviews. We sell coding solutions.
          </p>
          <br></br>
          <b>Privacy</b>
          <p>
            Your use of myrobin.io is subject to IntroLab's Privacy Policy.
          ...
          <p>
            Visiting myrobin.io or sending emails to IntroLab constitutes
          ...
          <p>
            ...
            entity. You acknowledge that IntroLab is not responsible for third
            party access to your account that results from theft or
            misappropriation of your account. IntroLab and its associates
            reserve the right to refuse or cancel service, terminate accounts,
            or remove or edit content at our sole discretion. IntroLab does not
            ...
            use myrobin.io only with permission of a parent or guardian.
          </p>
          <br></br>
          <b>Cancellation/Refund Policy</b>
          <p>
            You may cancel your subscription at any time. Please contact us at
            admin@myrobin.io with any questions.
          </p>
          <br></br>
          <b>Links to third party sites/Third party services</b>
          <p>
            myrobin.io may contain links to other websites ("Linked Sites"). The
            Linked Sites are not under the control of IntroLab and IntroLab is
            ...
            changes or updates to a Linked Site. IntroLab is providing these
            links to you only as a convenience, and the inclusion of any link
            does not imply endorsement by IntroLab of the site or any
            association with its operators.
          </p>
          <p>
            Certain services made available via myrobin.io are delivered by
            third party sites and organizations. By using any product, service
            or functionality originating from the myrobin.io domain, you hereby
            acknowledge and consent that IntroLab may share such information and
            data with any third party with whom IntroLab has a contractual
            relationship to provide the requested product, service or
            functionality on behalf of myrobin.io users and customers.
          </p>
          <br></br>
          <b>No unlawful or prohibited use/Intellectual Property</b>
          <p>
            You are granted a non-exclusive, non-transferable, revocable license
            to access and use myrobin.io strictly in accordance with these terms
            of use. As a condition of your use of the Site, you warrant to
            IntroLab that you will not use the Site for any purpose that is
          ...
          <p>
            ...
            used on the Site, is the property of IntroLab or its suppliers and
          ...
          <p>
            ...
            the Site. IntroLab content is not for resale. Your use of the Site
            ...
            IntroLab and the copyright owner. You agree that you do not acquire
            ...
            IntroLab or our licensors except as expressly authorized by these
            Terms.
          </p>
          <br></br>
          ...
          <p>
            IntroLab has no obligation to monitor the Communication Services.
            However, IntroLab reserves the right to review materials posted to a
            Communication Service and to remove any materials in its sole
            discretion. IntroLab reserves the right to terminate your access to
            any or all of the Communication Services at any time without notice
            for any reason whatsoever.
          </p>
          <p>
            {' '}
            IntroLab reserves the right at all times to disclose any information
            ...
            remove any information or materials, in whole or in part, at
            IntroLab's sole discretion.
          </p>
          <p>
            ...
            Service. IntroLab does not control or endorse the content, messages
            or information found in any Communication Service and, therefore,
            IntroLab specifically disclaims any liability with regard to the
            ...
            not authorized IntroLab spokespersons, and their views do not
            necessarily reflect those of IntroLab.
          </p>
          <p>
          ...
          <p>
            Materials provided to myrobin.io or posted on any myrobin.io web
            page IntroLab does not claim ownership of the materials you provide
            to myrobin.io (including feedback and suggestions) or post, upload,
            input or submit to any myrobin.io Site or our associated services
            (collectively "Submissions"). However, by posting, uploading,
            inputting, providing or submitting your Submission you are granting
            IntroLab, our affiliated companies and necessary sublicensees
            permission to use your Submission in connection with the operation
            of their businesses, including, without limitation, the rights to:
            copy, distribute, transmit, publicly display, publicly perform,
            reproduce, edit, translate and reformat your Submission; and to
            publish your name in connection with your Submission. These
            permissions apply to present and future businesses, which include
            but are not limited to other Internet Sites, in-person training
            programs, and Books and other Publications.
          </p>
          <p>
            No compensation will be paid with respect to the use of your
            Submission, as provided herein, unless otherwise stated. IntroLab is
            under no obligation to post or use any Submission you may provide
            and may remove any Submission at any time in IntroLab's sole
            discretion.
          </p>
          <p>
          ...
          <p>
            You will be able to connect your IntroLab account to third party
            accounts. By connecting your IntroLab account to your third party
          ...
          <p>
            The Service is controlled, operated and administered by IntroLab
            ...
            all local laws. You agree that you will not use the IntroLab Content
            accessed through myrobin.io in any country or in any manner
            prohibited by any applicable laws, restrictions or regulations.
          </p>
          <br></br>
          <b>Indemnification</b>
          <p>
            You agree to indemnify, defend and hold harmless IntroLab, its
            ...
            laws, rules or regulations. IntroLab reserves the right, at its own
            ...
            fully cooperate with IntroLab in asserting any available defenses.
          </p>
          <br></br>
          ...
          <p>
            ...
            IntroLab, INC AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR
            CHANGES IN THE SITE AT ANY TIME.
          </p>
          <p>
            INTROLAB, INC AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE
            ...
            WARRANTY OR CONDITION OF ANY KIND. INTROLAB, INC AND/OR ITS
          ...
          <p>
            {' '}
            INTROLAB, INC AND/OR ITS SUPPLIERS BE LIABLE FOR ANY DIRECT,
            ...
            INTROLAB, INC OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF THE
          ...
          <p>
            IntroLab reserves the right, in its sole discretion, to terminate
          ...
          <p>
            ...
            relationship exists between you and IntroLab as a result of this
            agreement or use of the Site. IntroLab's performance of this
            agreement is subject to existing laws and legal process, and nothing
            contained in this agreement is in derogation of IntroLab's right to
            ...
            provided to or gathered by IntroLab with respect to such use. If any
          ...
          <p>
            ...
            entire agreement between the user and IntroLab with respect to the
            ...
            and IntroLab with respect to the Site. A printed version of this
          ...
          <p>
            IntroLab reserves the right, in its sole discretion, to change the
            Terms under which myrobin.io is offered. The most current version of
            the Terms will supersede all previous versions. IntroLab encourages
