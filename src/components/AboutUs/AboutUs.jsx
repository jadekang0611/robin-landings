        ...
        <Row className='aboutus1'>
          <Col>
            ...
            <p>
              ...
              infrastructure by configuring career service software platforms
              like Handshake to streamline students' outcome experiences with
              career services and employers, bootcamps are still supporting
              thousands of students with spreadsheets without having any
              bootcamp-specific software to streamline this process.
            </p>
          </Col>
          <Col>
        ...
        <Row className='aboutus2'>
          <Col md={5}>
            ...
            <p>
              ...
              algorithm challenges, building applications, and communicating
              with their respective bootcamps about how they are doing with
              career preparation. With every activity the students put in, their
